...
const translations = {
  en: {
    ...
    chooseBranch: "Choose Evolution Path",
    branchNoun: "Noun Branch",
    branchVerb: "Verb Branch",
    branchAdj: "Adjective Branch",
    branchSelected: "{word} became a {branch}!",
    fusionReady: "Fusion Available!",
    familyFusion: "Family Fusion",
    fusionAvailable: "Fusion Available!",
    fusionConfirm: "Fuse {count} words from the {family} family?",
    fusionSuccess: "Behold! {word} has been summoned!",
  ...
  ko: {
    ...
    chooseBranch: "진화 경로 선택",
    branchNoun: "명사 경로",
    branchVerb: "동사 경로",
    branchAdj: "형용사 경로",
    branchSelected: "{word}(이)가 {branch}(으)로 진화했습니다!",
    fusionReady: "융합 가능!",
    familyFusion: "패밀리 융합",
    fusionAvailable: "융합 가능!",
    fusionConfirm: "{family} 패밀리의 단어 {count}개를 융합하시겠습니까?",
    fusionSuccess: "보라! {word}(이)가 소환되었습니다!",
    masteryRank: "마스터리 랭크",
    nextUnlock: "다음 잠금 해제",
